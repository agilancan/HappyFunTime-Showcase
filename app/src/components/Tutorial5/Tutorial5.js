        ...
        return (
            <View style={styles.outerContainer}>
                <View style={styles.innerContainer1}>      
                    <Image style={styles.tutorial1} source={require('../../../assets/Tutorial5/tutorial5.png')} />                         
                </View>
                <View style={styles.innerContainer2}>
                    <Text style={styles.innerContainer2Text}>Most importantly...{'\n'}relax...and have fun :)</Text>
                </View>
